    ...
    <div id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
       ...
       <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            <div className='flex-1'>
                ...
                >
                    I am an experienced FullStack Developer with over 5 years experience
                    and professional expertise in the field. Throughout my career, I have
                    the privilege of collaborating with prestigious organization, contributing 
                    to their immense success and growth.
                </p>
              ...
              <ul className='flex items-center gap-3 sm:gap-5'>
                {toolsData.map((tool,index)=>(<li className='flex items-center justify-center
                w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer
                hover:bg-lightHover dark:hover:bg-darkHover
                hover:-translate-y-1 transform transition-all duration-500' key={index}><Image src={tool}
                 alt='Tool' className='w-5 sm:w-7'/> </li>
                 ))
                 }
              </ul>
